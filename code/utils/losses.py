...
# This file is mainly borrowed from: https://github.com/michaelofsbu/SpatialCorrection/blob/main/utils/losses.py
...
class SoftDiceBCEWithLogitsLoss(nn.Module):
    def __init__(self, dice_smooth=1.0, w=0.5):
    ...
    def forward(self, net_output:Tensor, target:Tensor):
        ...
        return self.w*bce_loss + (1-self.w)*dsc_loss
